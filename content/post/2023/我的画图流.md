...
lastmod = 2023-01-31T10:36:24+08:00
tags = ["tool"]
categories = ["tool"]
draft = false
toc = true
...
{{< figure src="/ox-hugo/数据未分层.png" caption="<span class=\"figure-number\">Figure 3: </span>数据未分层" link="/ox-hugo/数据未分层.png" >}}

{{< figure src="/ox-hugo/数据分层.png" caption="<span class=\"figure-number\">Figure 4: </span>数据分层" link="/ox-hugo/数据分层.png" >}}

因为excalidraw 相当的灵活，甚至系统循环图我都是使用它来绘制的：

{{< figure src="/ox-hugo/人口与债务风险3.png" caption="<span class=\"figure-number\">Figure 5: </span>系统循环图" link="/ox-hugo/人口与债务风险3.png" >}}
...
{{< figure src="/ox-hugo/library.png" caption="<span class=\"figure-number\">Figure 6: </span>素材库" link="/ox-hugo/library.png" >}}
...
{{< figure src="/ox-hugo/cursed_line.gif" caption="<span class=\"figure-number\">Figure 7: </span>绘制曲线" link="/ox-hugo/cursed_line.gif" >}}
...
{{< figure src="/ox-hugo/土地财政时间线.png" caption="<span class=\"figure-number\">Figure 8: </span>土地财政时间线" link="/ox-hugo/土地财政时间线.png" >}}

{{< figure src="/ox-hugo/西方哲学史.png" caption="<span class=\"figure-number\">Figure 9: </span>西方哲学史演进历程" link="/ox-hugo/西方哲学史.png" >}}

Graphviz 官方示例库：

{{< figure src="/ox-hugo/unix.svg" caption="<span class=\"figure-number\">Figure 10: </span>Unix 家谱" link="/ox-hugo/unix.svg" >}}

{{< figure src="/ox-hugo/datastruct.svg" caption="<span class=\"figure-number\">Figure 11: </span>数据结构" link="/ox-hugo/datastruct.svg" >}}
